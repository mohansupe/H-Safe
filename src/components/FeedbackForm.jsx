...
export default function FeedbackForm(){
  ...
  if (done) return <div className="container mx-auto px-6 py-12 text-center"><div className="bg-slate-800 border border-slate-700 rounded-lg p-6 text-white">Thanks — we received your feedback.</div></div>
